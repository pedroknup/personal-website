...
export const SkillsPage = ({ removeHighlight, isHighlighted, isDarkMode: darkMode }: PageProps) => {
  ...
  return <SectionPage isDarkMode={darkMode} removeHighlight={removeHighlight} isHighlighted={isHighlighted} id="skills" paddingColumns={2} title="Skills" description="The tools and frameworks I reach for most often, with a rough sense of how much I trust myself in each.">
