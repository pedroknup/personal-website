...
export const AboutPage = ({ darkMode, removeHighlight, isHighlighted }: PageProps) => {
  return <div className={`about-container ${darkMode ? '' : 'light'}`}>
    <SectionPage darkMode={darkMode} removeHighlight={removeHighlight} isHighlighted={isHighlighted} id="about" paddingColumns={2} title="About">
      <span className="obj">
