...
export const BlogPage = ({ isDarkMode: darkMode, removeHighlight, isHighlighted }: PageProps) => {
  return <div className="blog-container">
    <SectionPage paddingColumns={2} isDarkMode={darkMode} removeHighlight={removeHighlight} isHighlighted={isHighlighted} id="blog" title="Artworks" description="My latest illustrations and videos">
