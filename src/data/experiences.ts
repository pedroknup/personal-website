  ...
  },
  {
    ...
    content: {
      content:
        ...
        `CEFET-MG, the Federal Center for Technological Education of Minas Gerais, is a prestigious Brazilian institution known for its excellence in technological and engineering education.
...
`
  ...
  },
  {
    ...
    defaultOpened: false,
    content: {
      content: `Pycom is a global Device-to-Cloud Internet of Things (IoT) technology company.
...
• Development of Pymakr online, a web-based IDE for Pycom devices that allows offline and online code deployment and debugging.
  ...
  },
  {
    ...
    content: {
      content:
        `Webbio B.V. is a digital agency providing custom-made web solutions.
...
`,
  ...
  },
  {
    ...
    content: {
      content:
        `ClubPetro is a customer loyalty company specializing in the fuel retail market.
